...
Test fixture fonts are not relicensed under the FTL. Their embedded notices and
repository-level attribution are documented in
`tests/fixtures/THIRD_PARTY_NOTICES.md`; fixture data is excluded from the
