...
| Measurement | Count |
|---|---:|
| Runnable exact-comparison cases | 7,542 |
| Passed cases | 7,542 |
| Failed cases | 0 |
| Explicitly pending cases | 3 |
| Covered manifest cases | 4,192 |
| Validated public API subjects | 1,543 |
| Validated public API input files | 1,537 |
| Logical declared cases | 4,284 |
| Concrete expanded cases | 7,545 |
| Functions with at least one C/Rust/C-ABI/WASM runtime route | 218 / 218 |

`7,542 / 7,542` means every runnable case in that execution matched; the 3
...
The committed ledger contains **4 / 5 clean runs**
...
|---|---:|
| Source commit | `ae8c5d525351d9599acae23a3d0564e5aa80afa7` |
| Samples | 10 |
| Weighted latency speedup versus C | 0.322x |
