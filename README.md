...
| Measurement | Count |
|---|---:|
| Runnable exact-comparison cases | 7,269 |
| Passed cases | 7,269 |
| Failed cases | 0 |
| Explicitly pending cases | 38 |
| Covered manifest cases | 4,140 |
...
`7,269 / 7,269` means every runnable case in that execution matched. It does
...
`660ffb48-3bc8-4995-ace8-525dbb51c468` from clean commit
`25846d907293f04d4337a60a5ddf28a824065baa`; its source-bound digest is
...
|---|---|
| Functions | 218 / 218 names, signatures, and traced function routes; 5,021 / 5,047 pinned-C runtime contract rows exact, with 26 pending |
