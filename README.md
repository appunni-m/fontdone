...
| Measurement | Count |
|---|---:|
| Runnable exact-comparison cases | 7,256 |
| Passed cases | 7,256 |
| Failed cases | 0 |
| Explicitly pending cases | 51 |
| Covered manifest cases | 4,127 |
...
`7,256 / 7,256` means every runnable case in that execution matched. It does
not turn the 51 pending cases into passes. Likewise, 218/218 function-route
...
`ef1090a4-3ed3-493f-aaa5-0d83d9853078` against clean commit
`2f05af7f3f3fd767ecc04679fce58abc9781af2b`.
...
|---|---|
| Functions | 218 / 218 names, signatures, and traced function routes; 5,008 / 5,047 pinned-C runtime contract rows exact, with 39 pending |
