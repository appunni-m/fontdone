...
The latest full parity snapshot was recorded on **2026-08-30** (UTC):

| Measurement | Count |
|---|---:|
| Runnable exact-comparison cases | 19,370 |
| Passed cases | 19,370 |
| Failed cases | 0 |
| Explicitly pending cases | 4 |
| Covered manifest cases | 4,381 |
| Validated public API subjects | 1,543 |
| Validated public API input files | 1,537 |
| Logical declared cases | 4,533 |
| Concrete expanded cases | 19,374 |
...
|---|---|
| Functions | 218 / 218 functions without unresolved subject routes; 218 / 218 names, signatures, and traced function routes; 12,851 / 17,114 pinned-C runtime contract rows exact; 4,263 pending |
