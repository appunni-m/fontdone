...
- [ ] Keep attribution, licenses, and the final FreeType and font-author acknowledgements.
...
The macOS ARM64 job also downloads the published C SDK, verifies its GitHub
checksum, and compiles and runs the C example with `make docs-sdk-example`.
