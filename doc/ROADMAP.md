...
`b4596d6b-c372-4714-9e24-08a1a3273df8` against source tree
`e4637b4bea8a6b0ede612b241df3f8ac89d45aac`: it passed 7,511 / 7,511 runnable
...
source-bound coverage run completed in 50.635 seconds; the preceding managed
...
baseline remains 51.991 seconds. Its instrumentation timers were about 44.39
seconds Rust FFI, 33.48 seconds C ABI, 33.22 seconds WASM, and about 15 ms
...
run is `3fa7d660-61a0-4e9c-a665-80d1388edcfd`, with snapshot
`f123d96e-2619-4825-8721-f990a9e42456`. The lane-split validation run
...
`3fa7d660-61a0-4e9c-a665-80d1388edcfd`, snapshot
`f123d96e-2619-4825-8721-f990a9e42456`) measured 50.635 seconds end to end.
...
execution (about 44.39 seconds Rust FFI, 33.48 seconds C ABI, and 33.22 seconds
