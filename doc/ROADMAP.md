...
`7d36f0c2-ae32-4cba-9aba-6d0e7d7ca2f2` against committed source
`e558f9b306ea1af408b05d3c0140deeaa279180f`: it passed 7,505 / 7,505 runnable
...
**10 / 12 categories complete**, with 5,248 / 5,248 runtime contract rows and
661 / 661 strict error routes exact; the remaining contract debt is the
...
source-matched coverage run completed in 50.861 seconds; the preceding managed
run completed in 89.882 seconds; the prior
execution-only warm measurement with the instrumented binary and expanded-input
cache warm was 50.482 seconds, the preceding commit-bound rebuild took 98.080
seconds, and the prior warm committed baseline remains 51.991 seconds. Its
instrumentation timers were about 44.05 seconds Rust FFI, 33.02 seconds C ABI,
32.80 seconds WASM, and about 13–14 ms comparison per lane. `make
...
current source-matched run measured 49,498 / 54,173 lines, 9,729 / 12,534
branches, 3,384 / 3,834 functions, and 68,131 / 75,345 regions. It passed
7,505 / 7,505 runnable parity comparisons with 0 failures. Its Coverage MCP
run is `5f84841d-26e8-49c5-be83-1cee05420341`, with snapshot
`303a72ac-0257-467d-9f93-badf84ec59bb`. The lane-split validation run
...
`5f84841d-26e8-49c5-be83-1cee05420341`, snapshot
`303a72ac-0257-467d-9f93-badf84ec59bb`) measured 50.861 seconds end to end.
The preceding managed run measured 89.882 seconds; the prior execution-only warm measurement was 50.482 seconds; the preceding
commit-bound rebuild took 98.080 seconds, and the prior warm committed baseline
remains 51.991 seconds.
The retained lane timers identify the remaining floor as instrumented parity
execution (about 44.05 seconds Rust FFI, 33.02 seconds C ABI, and 32.80 seconds
WASM), while comparison is about 13–14 ms per lane. Coverage MCP accepts the current LLVM JSON directly;
