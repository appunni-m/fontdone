...
`0678b7bf-09b7-4ac1-ae1c-9c411e590884`: it passed 7,542 / 7,542 runnable
...
`4e308b8b-524c-446e-b6b4-1fb4d8e05b59` in `doc/runtime_parity_evidence.json`.
The companion C-ABI scorecard run `6ca1b15a-ccb9-4740-a781-957bd61f4afe`
...
The current source-bound all-lane run `e91fbcc5-9c26-4235-acd0-bdf1f4bac67b`
completed in 71.817 seconds with snapshot
`5f5b82b2-57e3-49d3-9009-4a534b6d6450`. It measured 49,963 / 54,382 lines,
9,918 / 12,590 branches, 3,410 / 3,848 functions, and 68,737 / 75,611
