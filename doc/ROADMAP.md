...
`1376d5f7-127c-4de2-a4d6-b20954357ef4`: it passed 7,542 / 7,542 runnable
...
`f4b99ab0-1b4b-4e77-9207-a6ec5a4191f1` in `doc/runtime_parity_evidence.json`.
The companion C-ABI scorecard run `0d0fd204-57c5-4a62-a6ed-5b6be2a6782e`
...
The current source-bound all-lane run `1e2c11f5-4911-408d-8f55-c0462b08010c`
completed in 107.170 seconds with snapshot
`9192bd59-abc5-4763-ace5-16603970ac4c`. It measured 49,974 / 54,387 lines,
9,928 / 12,592 branches, 3,410 / 3,848 functions, and 68,748 / 75,614
...
concurrently; a historical two-worker
