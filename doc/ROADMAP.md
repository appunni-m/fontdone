...
`97c0bfda-1736-4bc9-af10-e1a1f5603589`: it passed 7,542 / 7,542 runnable
...
`d7264bbe-1eef-4809-ae18-8110bcc38cd7` in `doc/runtime_parity_evidence.json`.
The companion C-ABI scorecard run `728577dc-3b57-4d3b-9f41-ffb148225816`
...
The current source-bound all-lane run `08237caa-2c54-4264-9e7b-ba72aa8fae4e`
completed in 96.315 seconds with snapshot
`90d65800-8c5e-4652-9d07-74489a636957`. It measured 49,968 / 54,382 lines,
9,924 / 12,590 branches, 3,410 / 3,848 functions, and 68,744 / 75,611
