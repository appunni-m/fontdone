...
`83a11c2d-dd6d-47eb-911c-bf9ef2808920`: it passed 7,542 / 7,542 runnable
...
`f185a497-aeb8-49db-9ff7-8d59a720fc53` in `doc/runtime_parity_evidence.json`.
The companion C-ABI scorecard run `a94357ca-b22b-4c72-839c-7d804fab772f`
...
The current source-bound all-lane run `a5bbf85d-c9e4-48c1-a5ff-7504d55d5c55`
completed in 80.408 seconds with snapshot
`888e4e04-fe4d-4fd3-a17c-cc6fa5d61c6e`. It measured 49,959 / 54,382 lines,
9,914 / 12,590 branches, 3,410 / 3,848 functions, and 68,732 / 75,611
