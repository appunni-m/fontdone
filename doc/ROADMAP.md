...
source-matched run completed in 52.354 seconds, with all three backend lanes
still passing the exact matrix. Its instrumentation timers were about 45.73
seconds Rust FFI, 34.46 seconds C ABI, 34.12 seconds WASM, and 0.015 seconds
comparison. `make
...
repeated. The latest warm run measured 49,443 / 54,150 lines, 9,707 / 12,520
...
run is `a24f431c-5a5b-4c73-8fa4-2738888d0db2`, with snapshot
`7724fcea-e4b9-408f-9f80-9447f00f3363`. The lane-split validation run
...
`7724fcea-e4b9-408f-9f80-9447f00f3363`) measured 52.354 seconds on the clean
...
execution (about 45.73 seconds Rust FFI, 34.46 seconds C ABI, and 34.12 seconds
