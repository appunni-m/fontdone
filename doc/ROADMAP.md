...
`b48bd7a1-918c-4932-abc6-7a389f3f9b5a`: it passed 7,542 / 7,542 runnable
...
`2a878a19-6ad3-49b5-b065-338e23e6b156` in `doc/runtime_parity_evidence.json`.
The companion C-ABI scorecard run `e0b79df7-c784-497f-b81a-752177df2c0e`
...
The current source-bound all-lane run `782ee38f-0057-418f-b0c4-d3a624ecc798`
completed in 108.210 seconds with snapshot
`d06e0759-2457-4a5e-a3cf-9e3fdb2ad4af`. It measured 49,967 / 54,382 lines,
9,923 / 12,590 branches, 3,410 / 3,848 functions, and 68,743 / 75,611
