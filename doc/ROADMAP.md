...
`1b4d5976-b4e5-43c7-9e4f-547c47ebfe26`: it passed 7,542 / 7,542 runnable
...
`7505f21c-9346-4a9b-8923-ac3a56de44d3` in `doc/runtime_parity_evidence.json`.
The companion C-ABI scorecard run `2fcbdfbb-31be-4068-ab53-4aabf97133c8`
...
The current source-bound all-lane run `5ffeaf46-b39a-44dc-bad6-4d903b1a60cc`
completed in 70.958 seconds with snapshot
`8f30b182-5c42-433c-b954-d4fe1ce975b7`. It measured 49,957 / 54,382 lines,
9,911 / 12,590 branches, 3,410 / 3,848 functions, and 68,730 / 75,611
