...
`2a86b5f7-2dd7-4211-989b-f6da4640070c`: it passed 7,542 / 7,542 runnable
...
`ab32b171-441d-4fb5-be54-c2968923290c` in `doc/runtime_parity_evidence.json`.
...
The current source-bound all-lane run `e5dd45f6-d1dc-4c1d-a7ee-8ea143b8441d`
completed in 115.508 seconds with snapshot
`55b978d6-8073-4afa-8135-5938b10a54e2`. It measured 49,975 / 54,387 lines,
9,929 / 12,592 branches, 3,410 / 3,848 functions, and 68,749 / 75,614
regions; the parity matrix passed 7,542 / 7,542 in each backend. This source-
changing validation includes the instrumented rebuild and an explicit
`COVERAGE_UNIFIED_WORKERS=2` override; it is not a speed comparison against the
previous warm snapshot. The lanes already run concurrently; a historical two-worker
