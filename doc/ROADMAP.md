...
`07f71e18-873e-4c92-973b-a918993ba75c`: it passed 7,567 / 7,567 runnable
...
`85f509b7e5d15f641413db274a7ffb5d22ea15cdf1197a1ab4784651a40cdaa9`.
The tracked C-ABI scorecard is **10 / 12 categories complete**; C11.3 is
7 / 8 and C12.3 is 1 / 5. The Windows import-library item and four fresh
target-lane bundles remain.
...
The current source-bound all-lane run `cfa3fcac-b5b6-4939-ba35-904ac08bc5f8`
completed in 75.320 seconds with snapshot
`afe5d428-3b0e-4684-af4d-655637182d2e`. It measured 50,119 / 54,388 lines,
9,988 / 12,599 branches, 3,410 / 3,822 functions, and 68,865 / 75,559
regions; the parity matrix passed 7,567 / 7,567 in each backend. This
source-bound run rebuilt the instrumented state after the SBIT arithmetic change;
the retained lane timers were 24.260s Rust FFI, 24.360s C ABI, and 25.690s
WASM, with roughly 11ms comparison work per lane. The lanes
