...
The follow-up Coverage MCP run must use the pushed full baseline and these
expanded runtime IDs; any selected-subset result will be reported only as
additive reachability evidence, not as a replacement full-denominator score.
