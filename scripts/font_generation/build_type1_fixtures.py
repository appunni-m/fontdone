...
INPUT_AUX_OUT_DIR = FIXTURE_ROOT / "input" / "auxiliary" / "type1"
...
def build_parser_edge_programs() -> None:
    ...
    programs = [
        ...
        (
            "parser-hvcurveto-single-operand.pfb",
            "Type1ParserHvCurveSingleOperand",
            [
                500,
                0,
                "hsbw",
        ...
        (
            "parser-vhcurveto-single-operand.pfb",
            "Type1ParserVhCurveSingleOperand",
            [
                500,
                0,
                "hsbw",
        ...
        (
            "parser-hvcurveto-two-operands.pfb",
            "Type1ParserHvCurveTwoOperands",
            [
                500,
                0,
                "hsbw",
        ...
        (
            "parser-vhcurveto-two-operands.pfb",
            "Type1ParserVhCurveTwoOperands",
            [
                500,
                0,
                "hsbw",
        ...
        (
            "parser-hvcurveto-three-operands.pfb",
            "Type1ParserHvCurveThreeOperands",
            [
                500,
                0,
                "hsbw",
