...
mod tests {
    ...
    fn coordinate_accessors() {
        let mut z = zone();
        assert_eq!(z.cur(0), (1, 4));
        assert_eq!(z.org(2), (9, 12));
        assert_eq!(z.orus(1), (14, 17));
        assert_eq!(z.cur(99), (0, 0));
        assert_eq!(z.org(99), (0, 0));
        assert_eq!(z.orus(99), (0, 0));

        z.set_cur(1, 100, 200);
        assert_eq!(z.cur(1), (100, 200));
        z.set_cur(99, 100, 200); // out of range is ignored
        assert_eq!(z.cur(2), (3, 6));
    }
    ...
    fn tag_operations() {
        ...
        z.clear_tag(0, 2);
        assert_eq!(z.tag(0), 1);
        z.set_tag(99, 4); // out of range is ignored
        assert_eq!(z.tags.len(), 3);
    }

    #[test]
    fn real_point_count() {
        let mut z = zone();
        assert_eq!(z.n_real_points(), 3);
        z.n_points = 2; // saturating subtraction never underflows
        assert_eq!(z.n_real_points(), 0);
    }
}
