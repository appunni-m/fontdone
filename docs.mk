...
DOCS_BENCHMARK_KIND ?= fontdone
DOCS_BENCHMARK_SOURCE ?= doc/compatibility_snapshot.json
DOCS_BENCHMARK_OUTPUT ?= site-assets/benchmark.json
DOCS_REPOSITORY ?= appunni-m/fontdone
...
.PHONY: docs-sdk-example
docs-sdk-example: ## Download the checksummed macOS ARM64 SDK and execute the C guide
	$(PYTHON) scripts/check_docs_registry.py --sdk-only
