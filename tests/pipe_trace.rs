...
//! `PIPE_FONT_PATH=tests/fixtures/input/fonts/DejaVuSans.ttf PIPE_SIZE=10
//! PIPE_CHAR='$' RUST_LOG=autohint::pipeline=trace make test-pipe-trace`
...
fn trace_one_glyph() {
    let font_path = std::env::var("PIPE_FONT_PATH")
        .unwrap_or_else(|_| "tests/fixtures/input/fonts/DejaVuSans.ttf".into());
