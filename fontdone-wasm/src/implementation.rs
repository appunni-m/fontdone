...
pub extern "C" fn fontdone_wasm_stream_open_gzip(
    ...
    let source_bytes = match gzip_source_bytes(
        source.cast_mut(),
        source_ref.base,
        source_ref.read,
        source_len,
...
fn lzw_source_bytes(
    ...
    // null read callback before calling this helper.  The remaining path has
    // a callback by invariant, matching the public FreeType stream contract.
